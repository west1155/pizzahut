...
export const ProductCard: React.FC<ProductType> = ({ id, name, price, imgURL, items, categoryName, ingredients, className }) => {
    const [openModal, setOpenModal] = React.useState(false);

    return (
        <div className={className}>
            <div
                className={cn('border border-gray-500-100 rounded-2xl p-4 hover:shadow-md transition-all duration-200 cursor-pointer h-full')}
            ...
            <ChooseProductModal
                product={{ id, name, imgURL, items, categoryName, ingredients }}
                open={openModal}
